...
OWNERSHIP: dict[str, tuple[str, ...]] = {
    ...
    "C-11": ("src/ats_scan/embeddings/", "src/ats_scan/scoring/dimensions/s3_semantic.py", "tests/unit/scoring_semantic/", "changelog.d/C-11.", "docs/dep-requests/C-11.md", "docs/contract-change/C-11-"),
    "C-12": ("src/ats_scan/scoring/dimensions/s4_experience.py", "src/ats_scan/scoring/dimensions/s5_title.py", "src/ats_scan/scoring/dimensions/s6_domain.py", "src/ats_scan/scoring/dimensions/s7_education.py", "src/ats_scan/scoring/dimensions/s9_trajectory.py", "src/ats_scan/scoring/dimensions/s10_parseability.py", "tests/unit/scoring_profile/", "changelog.d/C-12.", "docs/dep-requests/C-12.md", "docs/contract-change/C-12-"),
