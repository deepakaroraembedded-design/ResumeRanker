...
def run(
    ...
    """Run the full ATS-Scan pipeline."""
...
def main() -> None:
    """Entry point for the installed ``ats-scan`` console script."""
    app()
